      ...
      <View style={{flex:1}}>
        ...
        <View style={ baseStyles.content }>
          ...
          <LinearGradient colors={['#2699d3', '#33a0d6', '#28a0dc']} style={ [baseStyles.linearGradient, baseStyles.content] }>
            <View style={ [baseStyles.centeredContainer, {padding: 0,marginLeft:0}] }>
              <View style={ [styles.pageTitle, {marginTop: 16}] }>
                <Text style={ [baseStyles.text, styles.pageTitleText, {fontSize: 20, }] }>
                  Create Your Account
                </Text>
                <Text style={ [baseStyles.text, styles.pageSubtitleText, {marginTop: 24,fontSize:15}] }>
