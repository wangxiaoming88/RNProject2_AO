  ...
  */
  ...
  _onSubmit(data) {
    ...
    this.props.dispatch(updateData(data, () => {
      Analytics.peopleFirstName(data.firstName);
      Analytics.peopleLastName(data.lastName);
      // Analytics.peopleEmail(data.email);
  ...
  render() {
    ...
    const textInputStyle = {
      style: {
        height:40, color: 'gray',fontSize:15,
      }
    };
      ...
      <View style={ baseStyles.container }>
        ...
        <View style={styles.bottom}>
          ...
          <TouchableOpacity onPress={ this.logout.bind(this) }>
            <Text style={[baseStyles.link, styles.logout]}>Log out</Text>
          </TouchableOpacity>
        </View>
        </ScrollView>
      </View>
